...
const MicrowaveTesting = () => {
  ...
  return (
    <Layout title="Microwave Testing" description="Professional microwave leakage testing services in Melbourne">
      ...
      {/* Standards Banner */}
      <div className="bg-gray-200 text-gray-900 py-4 sm:py-6">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-10 text-center">
      ...
      <div className="bg-white py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-10">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-stretch">
            ...
            <div className={`flex flex-col gap-4 sm:gap-6 h-full transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <div className="relative flex-1 rounded-xl overflow-hidden transition-all duration-500 min-h-[200px] sm:min-h-[240px]">
                <Image
      ...
      <div className="bg-gray-200 py-6 sm:py-8">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-10 text-center">
          <p className="text-base sm:text-lg md:text-xl font-medium text-gray-900 leading-tight">
              ...
              <div className="bg-white rounded-xl transition-all duration-500">
                ...
                <ul className="space-y-3 sm:space-y-4">
                  <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="text-base sm:text-lg text-gray-700">An electrical safety test to ensure appliance safety compliance.</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">2.</span>
                    <span className="text-base sm:text-lg text-gray-700">A physical inspection and correct functioning assessment to check for damage and deterioration.</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">3.</span>
                    <span className="text-base sm:text-lg text-gray-700">A power output and electrical cords inspection for compliance with acceptable standards of electrical flow and magnetization.</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">4.</span>
                    <span className="text-base sm:text-lg text-gray-700">A radiation emissions inspection to evaluate radiation levels.</span>
                  </li>
                </ul>
              </div>
            </div>
