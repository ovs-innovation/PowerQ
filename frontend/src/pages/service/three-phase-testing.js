  ...
  return (
    <Layout title="Three Phase Testing" description="Professional three phase electrical testing services in Melbourne">
      ...
      <div className="bg-gray-200 py-6 sm:py-8">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-10">
          <p className="text-base sm:text-lg md:text-xl font-bold text-gray-900 text-center leading-tight">
            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <div className="bg-white transition-all duration-500">
                ...
                <div className="space-y-4 sm:space-y-6">
                  {/* Test 1 */}
                  <div className="border-l-4 border-red-600 pl-3 sm:pl-6">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">1. Earth Continuity</h3>
                    <p className="text-base sm:text-lg text-gray-700 leading-6 sm:leading-7">
                    ...
                    <p className="text-base sm:text-lg font-semibold text-red-600 mt-2">
                  ...
                  {/* Test 2 */}
                  <div className="border-l-4 border-red-600 pl-3 sm:pl-6">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">2. Insulation resistance</h3>
                    <p className="text-base sm:text-lg text-gray-700 leading-6 sm:leading-7">
                  ...
                  {/* Test 3 */}
                  <div className="border-l-4 border-red-600 pl-3 sm:pl-6">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">3. Earth Leakage</h3>
                    <p className="text-base sm:text-lg text-gray-700 leading-6 sm:leading-7 mb-2">
                ...
                <div className="mt-6 sm:mt-8">
                  ...
                  <Link href="/request-a-quote">
                    <button className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl uppercase flex items-center gap-2 text-sm sm:text-base w-full sm:w-auto justify-center">
