          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <p className="text-lg text-gray-700 leading-8 mb-6">
                Testing and tagging electrical equipment is essential for safety, to prevent risks to people, property, and the work environment. Unmaintained electrical appliances can lead to serious injury or death, and less severe events like skin burns or organ damage. Employers and self-employed personnel must have their equipment tested/tagged regularly to avoid fatal results and keep workers safe. Testing and tagging is a necessary precaution that should not be overlooked.
              </p>
