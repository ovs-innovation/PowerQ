...
const RCDSafetySwitches = () => {
  ...
  return (
    <Layout title="RCD/Safety Switches" description="Professional RCD and safety switch testing services in Melbourne">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
            ...
            <div className={`order-1 lg:order-2 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <div className="bg-white transition-all duration-500">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-7 sm:leading-8 mb-3 sm:mb-4">
      ...
      <div className="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-10">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <div className="bg-red-500 rounded-xl p-4 sm:p-6 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 h-full min-h-[280px] sm:min-h-[320px] md:min-h-[380px] lg:min-h-[440px] flex flex-col justify-start">
                ...
                <p className="text-base sm:text-lg text-gray-200 leading-7 sm:leading-8">
                ...
                <div className="bg-red-100 rounded-lg p-3 sm:p-4 mt-2 sm:mt-3">
      ...
      <div className="bg-white py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-10">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
            <div className={`relative pb-12 sm:pb-16 md:pb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <div className="relative rounded-xl overflow-hidden transition-all duration-500 lg:h-full min-h-[280px] sm:min-h-[320px] md:min-h-[340px] lg:min-h-[500px]">
                <Image
              ...
              <div className="absolute right-1 sm:right-2 -bottom-16 sm:-bottom-20 md:-bottom-28 lg:right-2 rounded-xl overflow-hidden shadow-2xl w-3/5 sm:w-2/5 md:w-3/5 lg:w-2/3">
                <Image
              ...
              <div className="bg-white transition-all duration-500">
                ...
                <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                  <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="text-base sm:text-lg text-gray-700">The push button test</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">2.</span>
                    <span className="text-base sm:text-lg text-gray-700">Visual inspection and operational testing</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">3.</span>
                    <span className="text-base sm:text-lg text-gray-700">Tripping time to test for trip time as prescribed by Australian standards</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">4.</span>
                    <span className="text-base sm:text-lg text-gray-700">Two fast trip and two non-trip tests Tripping current test</span>
                  </li>
                  <li className="flex items-start gap-2 sm:gap-3">
                    <span className="text-red-600 font-bold text-lg sm:text-xl mt-0.5 sm:mt-1 flex-shrink-0">5.</span>
                    <span className="text-base sm:text-lg text-gray-700">Inspection of switchboard door, hinge, lock and weatherproof seal</span>
                  </li>
                </ul>
                <Link href="/request-a-quote">
                  <button className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl text-sm sm:text-base w-full sm:w-auto">
                    Get a Quote
                  </button>
                </Link>
              </div>
