          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <div className="bg-white rounded-xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-gray-200">
                ...
                <p className="text-lg text-gray-700 leading-8 mb-6">
                  Exit light testing is done to ensure emergency exit lights remain illuminated for at least 90 minutes on battery power. The test is not complicated, as most emergency exit lights come with a small "push to test" button.
                </p>
