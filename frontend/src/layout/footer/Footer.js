      ...
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10">
        <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 lg:py-16 justify-between">
          {storeCustomizationSetting?.footer?.block1_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-4">
              ...
              <ul className="text-sm flex flex-col space-y-3">
                <li className="flex items-baseline">
                  <Link
                    ...
                    className="text-gray-600 inline-block w-full hover:text-[#EF4036]"
                  >
                    <CMSkeleton
                      count={1}
                      height={10}
              ...
              >
                <div className="relative w-20 h-1">
                  <Image
                    ...
                    src={"/logo/full-logo.png" || storeCustomizationSetting?.footer?.block4_logo}
                    alt="PowerQ"
                  />
                </div>
              </Link>
            ...
            <div className="col-span-1 text-center hidden lg:block md:block">
              {storeCustomizationSetting?.footer?.bottom_contact_status && (
                <div>
                  ...
                  <h5 className="text-2xl font-bold text-[#EF4036] leading-7">
                    {/* +012345-67900 */}
