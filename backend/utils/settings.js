const setting = [
  {
    setting: {
      ...
      post_code: "2030",
      contact: "019579034",
      email: "PowerQ@gmail.com",
      website: "PowerQ-admin.vercel.app",
      default_currency: "€",
      default_time_zone: "Europe/London",
      default_date_format: "MMM D, YYYY",
      receipt_size: "57-mm",
      from_email: "sale@PowerQ.com",
    ...
    setting: {
      ...
      home: {
        ...
        quick_delivery_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our PowerQ shop and get some special offers. See Our latest discounted products from here and get a special discount.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem PowerQ-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our PowerQ Store",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our PowerQ shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem PowerQ-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_title: {
          en: "Welcome to our PowerQ shop",
          de: "Willkommen in unserem PowerQ-Shop",
        },
        top_description: {
      ...
      faq: {
        ...
        faq_one: {
          en: "How does the PowerQ work?",
          de: "Wie funktioniert der PowerQ?",
        },
        description_one: {
        ...
        faq_five: {
          en: "What is PowerQ EC2 auto scaling?",
          de: "Was ist die automatische Skalierung von PowerQ EC2?",
        },
        description_five: {
          en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
        ...
        faq_six: {
          en: "What are the benefits of using PowerQ affliate?",
      ...
      seo: {
        ...
        meta_title:
          "PowerQ - React Grocery & Organic Food Store e-commerce Template",
        meta_url: "https://PowerQ-store-nine.vercel.app/",
      },
    },
